...
struct nvm_dev_ops {
	...
	nvm_submit_io_fn	*submit_io_nowait;
...
struct nvm_dev {
	...
	void *dma_pool;
	struct kmem_cache *cmd_kmemcache;
...
extern int nvm_submit_io_nowait(struct nvm_tgt_dev *tgt_dev, struct nvm_rq *rqd);
